...
class QuizBotManagerTest extends BaseAkkaWordTest("quizBotManagerTest") with MockFactory with InMemoryCleanup {
  ...
  "A QuizBotManager" should {
    ...
    "resume a quiz " in {
      ...
      quizBotManager ! CreateRandomQuiz("uid")
      expectMsg(QuizStarted)
      changedQuizBotStateAndKillIt()
      expectMsg(QuizStoped)
  ...
  private def changedQuizBotStateAndKillIt() = {
